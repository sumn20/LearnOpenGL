...
#include <cmath>
#include "Constant.h"
 const char *vertexShaderSourceReverse = "#version 330 core\n"
                                        ...
                                        "}\0";
 const  char *fragmentShaderSourceReverse = "#version 330 core\n"
                                           "out vec4 FragColor;\n"
...
int MovingTriangle::init() {
    ...
    glShaderSource(vertexShader,1,&vertexShaderSourceReverse,nullptr);
    ...
    */
    ...
    glShaderSource(fragmentShader,1,&fragmentShaderSourceReverse, nullptr);
...
void MovingTriangle::framebuffer_size_callback(GLFWwindow *window, int width, int height) {
    //告诉OpenGL渲染窗口的尺寸大小，即视口(Viewport)
    glViewport(0, 0, width, height);
}

void MovingTriangle::processInput(GLFWwindow *window) {
